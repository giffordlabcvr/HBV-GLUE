...
var whereClause = "sequenceID like '%4' and patent_related = null and gb_length > 3000";
...
_.each(rotationResultObjs, function(rotationResultObj) {
	if(rotationResultObj.status == "NO_ROTATION_NECESSARY") {
		...
		throw new Error("Unexpected rotation status '"+rotationResultObj.status+"' for sequence "+rotationResultObj.rotationResultObj.status);
	}
});